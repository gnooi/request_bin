...
const BinDetails = () => {
  ...
  useEffect(() => {
    ...
    binService
      .getRequestById(endpoint, selectedRequestId)
      .then((data) => {
        ...
        <div className="bin-details__card">
          <div className="bin-details__info">
            <div className="bin-details__info-left">
              <Link className="bin-details__back" to="/">
                ← Back to bins
              </Link>
          ...
          <div className="bin-details__body">
            {loading && (
              <p className="bin-details__status">Loading requests…</p>
            )}
            {!loading && error && (
              <p className="bin-details__status">{error}</p>
            )}
            {!loading && !error && (
              <>
                <RequestList
